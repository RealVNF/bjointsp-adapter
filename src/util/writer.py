...
def create_template(sfc_name, sf_list, sf_delays_dict):
    """
        Creates a template dict for BJointSP based on the network file parameters.
    ...
    Parameters:
        ...
        sf_delays_dict
    Returns:
        template_dict: A dictionary containing the template
    """
...
def create_source_object(traffic_info, sf_list, sfc_name, flow_dr_mean):
    """
        - creates the source list for the BJointSP based on the traffic info from the simulator
